...
description: "Here you will find all relevant information about Ivan Lopez-Valdivia research, including latest papers, current research, contact information and more."
---
  ...
  <table style="width:100%;">
    <tr>
      ...
      <td style="width:35%; text-align:center; vertical-align:top;">
        <img src="Plastiticidad_v1.png" style="max-width:100%; border-radius:6px;">
      </td>

      <!-- Columna texto (derecha) -->
      <td style="width:65%; vertical-align:top; padding-left:15px;">
        <h3><strong>August 10th, 2026</strong></h3>
        <p>
          New concept: the adaptive value of phenotypic plasticity relies on the 
          <strong>trajectory towards an optimum phenotype</strong>. 
          More details in our new 
          <a href="https://www.biorxiv.org/content/10.64898/2026.08.10.744026v1">pre-print</a>.
        </p>
      </td>
    </tr>
  </table>
...
<div style="border:1px solid #ddd; padding:15px; border-radius:8px; margin-bottom:25px;">
  ...
  <table style="width:100%;">
    <tr>
      <!-- Imagen izquierda -->
      <td style="width:35%; text-align:center; vertical-align:top;">
        <img src="Elena_v1.png" style="max-width:100%; border-radius:6px;">
      </td>

      <!-- Texto derecha -->
      <td style="width:65%; vertical-align:top; padding-left:15px;">
        <h3><strong>July 11th, 2026</strong></h3>
        <p>
          <a href="https://link.springer.com/article/10.1007/s11104-026-08822-y">New paper</a> on root phenotypes 
          and rhizosphere microbial diversity in maize from 
          <a href="https://scholar.google.com/citations?user=Gtoeh2YAAAAJ&hl=it">Elena Giuliano</a>, 
          published in <em>Plant and Soil</em>.
        </p>
      </td>
    </tr>
  </table>
...
<div style="border:1px solid #ddd; padding:15px; border-radius:8px; margin-bottom:25px;">
  ...
  <table style="width:100%;">
    <tr>
      <!-- Imagen izquierda -->
      <td style="width:35%; text-align:center; vertical-align:top;">
        <img src="matias_v1.png" style="max-width:100%; border-radius:6px;">
      </td>

      <!-- Texto derecha -->
      <td style="width:65%; vertical-align:top; padding-left:15px;">
        <h3><strong>April 28th, 2026</strong></h3>
        <p>
          New concept: the <strong>rhizochron</strong>, defined as the thermal time period between the emergence 
          of nodal roots on successive stem nodes, introduced by 
          <a href="https://www.linkedin.com/in/mat%C3%ADas-schierenbeck-040a4553/">Matías Schierenbeck</a>.  
          Full details available in the 
          <a href="https://www.biorxiv.org/content/10.64898/2026.04.24.720680v1.abstract">pre-print</a>.
        </p>
      </td>
    </tr>
  </table>
...
![Field and greenhouse studies](Field_greenhouse_studies.jpg)

Maize pollinations done by [Darshan Damodaran](https://bsky.app/profile/darshandamodaran02.bsky.social)
...
* **Ivan Lopez-Valdivia**, Miguel Vallebueno-Estrada, Harini Rangarajan, Kelly Swarts, Bruce F. Benz, Michael Blake, [Jagdeep Singh Sidhu](https://scholar.google.com/citations?user=fJ8j8mYAAAAJ&hl=en), Sergio Perez-Limon, Ruairidh J. H. Sawers, Hannah Schneider, Jonathan P. Lynch. In silico analysis of the evolution of root phenotypes during maize domestication in Neolithic soils of Tehuacán, New Phytologist [Full Record](https://nph.onlinelibrary.wiley.com/doi/10.1111/nph.70245)
