...
* ### **August 10th, 2026** - New concept: the adaptive value of phenotypic plasticity relies on the **trajectory towards an optimum phenotype**. More details in our new [pre-print](https://www.biorxiv.org/content/10.64898/2026.08.10.744026v1).

* ### **July 11th, 2026** - [New paper](https://link.springer.com/article/10.1007/s11104-026-08822-y) on root phenotypes and rhizosphere microbial diversity in maize from [Elena Giuliano](https://scholar.google.com/citations?user=Gtoeh2YAAAAJ&hl=it) published in Plant ans Soil.

* ### **April 28th, 2026** - New concept: the **rhizochron**, defined as the thermal time period between the emergence of nodal roots on successive stem nodes, by [Matías Schierenbeck](https://www.linkedin.com/in/mat%C3%ADas-schierenbeck-040a4553/). Check all the details in the following [pre-print](https://www.biorxiv.org/content/10.64898/2026.04.24.720680v1.abstract).
